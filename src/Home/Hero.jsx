...
const Hero = ({ children }) => {
  return (
    <div className="text-center flex flex-col gap-5 items-center justify-center  min-[768px]:text-left  min-[768px]:items-start  min-[820px]:w-[400px] min-[1280px]:w-[600px]">
      <div>
