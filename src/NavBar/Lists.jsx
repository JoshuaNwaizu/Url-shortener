    ...
    <>
      {navListsItems.map((item, index) => (
        <div
          ...
          key={index}
        >
          <ul className="flex max-[1023px]:flex-col min-[1024px]:flex-row items-center gap-10 max-[1023px]:bg-[#3A3054] max-[1023px]:py-8 max-[1023px]:w-[90%] max-[1023px]:text-xl max-[1023px]:font-bold text-center max-[1023px]:text-[#fff] rounded-xl  min-[1024px]:w-[80%] min-[1024px]:justify-between z-20">
