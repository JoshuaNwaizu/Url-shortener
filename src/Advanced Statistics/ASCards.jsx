...
const ASCards = () => {
  return (
    <div className="mx-6 mt-24 mb-12  min-[768px]:mx-10 min-[820px]:mx-14 min-[884px]:mx-[5rem] min-[1024px]:mb-[10rem] min-[1280px]:mx-[8rem] min-[1300px]:mx-[12rem]">
          ...
          <div key={item.description}>
            ...
            <div
              className={`bg-[#fff]  flex flex-col items-center justify-center px-7 py-10 rounded-lg min-[1024px]:px-3 ${
                ...
                item.top
                  ? 'min-[1024px]:translate-y-[4.5rem] min-[1300px]:px-[1rem]'
                  : undefined
              }`}
            >
              <div
